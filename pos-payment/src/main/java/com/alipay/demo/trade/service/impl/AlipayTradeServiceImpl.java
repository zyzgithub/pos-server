...
public class AlipayTradeServiceImpl extends AbsAlipayTradeService {
    ...
    public AlipayTradeServiceImpl(ClientBuilder builder) {
        ...
        setClient(new DefaultAlipayClient(builder.getGatewayUrl(), builder.getAppid(), builder.getPrivateKey(),
    ...
    public AlipayF2FPayResult tradePay(AlipayTradePayContentBuilder builder) {
        ...
        String bizContent = JSON.toJSONString(builder);
        request.setBizContent(bizContent);
        getLogger().info("trade.pay bizContent:" + request.getBizContent());

        AlipayTradePayResponse response = (AlipayTradePayResponse) getResponse(getClient(), request);
