...
public class TestAliPaySimulate implements TestPaySimulate {

	private static final Logger logger = LoggerFactory.getLogger(TestAliPaySimulate.class);

	private static String aliPayUrlTest = "http://apptest.0085.com/pay/pay/ali/payRetQuery.action?orderNo=PAY_ID";
	private static String aliNotifyUrlTest = "http://apptest.0085.com/takeOutController/alipaynotify.do";
	
	private static String aliPayUrlProd = "http://pay.0085.com/pay/pay/ali/payRetQuery.action?orderNo=PAY_ID&transactionId=2016061821001004930292771073";
	private static String aliNotifyUrlProd = "http://no1.0085.com/takeOutController/alipaynotify.do";
	...
	public JSONObject getOrderStatus(String setting, String payId) {
		String url = aliPayUrlTest.replace("PAY_ID", payId);
		if("prod".equals(setting)){
			url = aliPayUrlProd.replace("PAY_ID", payId);
		}
	...
	public void fixOrder(String setting, String payId) {
		...
		String url = aliNotifyUrlTest;
		if("prod".equals(setting)){
			url = aliNotifyUrlProd;
		}
	...
	public static void main(String[] args) {
		TestPaySimulate simulate = new TestAliPaySimulate();
		simulate.getOrderStatus("prod", "146624846173739");
