...
<div class="wrapper">   
	...
	<script type="text/javascript" src="${basePath }/plug-in/taskout/js/order.js?id=6"></script>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#loading_div").click(function(){
				...
				orderListMng.loadMore(url, orderListMng.unpayState);
			});
			...
			if(omvList){
				orderListMng.orderListByState(omvList, orderListMng.unpayState);
			}
		});
