...
<t:datagrid name="departList" title="部门列表" actionUrl="${basePath }/departController.do?departgrid" treegrid="true" idField="departid" pagination="false" >
 ...
 <t:dgDelOpt url="${basePath }/departController.do?del&id={id}" title="删除"></t:dgDelOpt>
</t:datagrid>
<div id="departListtb" style="padding: 3px; height: 25px">
 <div style="float:left;">
  <a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('部门录入','${basePath }/departController.do?add','departList')">部门录入</a>
  <a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="update('部门编辑','${basePath }/departController.do?update','departList')">部门编辑</a>
 </div>
