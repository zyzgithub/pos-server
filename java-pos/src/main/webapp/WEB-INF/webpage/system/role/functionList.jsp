...
<html>
  ...
  <script type="text/javascript">
	...
	function op() {
		...
		jq.ajax({
			...
			cache : false,
			type : 'POST',
			url : basePath+'/roleController.do?saveOperate&fp=' + a + '&roleId=' + jq("#roleId").val(), // 请求的action路径
 ...
 <body>
  <t:datagrid name="functionList" title="权限管理" actionUrl="${basePath }/roleController.do?setOperate&roleId=${roleId}" idField="functionid" treegrid="true" pagination="false">
