...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" layout="div" dialog="true" action="${basePath }/roleController.do?saveRole">
    ...
    <fieldset class="step">
     ...
     <div class="form">
      ...
      <input name="roleCode" id="roleCode" ajaxurl="${basePath }/roleController.do?checkRole&code=${role.roleCode }" class="inputxt" value="${role.roleCode }" datatype="s2-15">
