...
<div class="easyui-layout" fit="true" >
 <div region="center" style="padding: 1px;">
  <t:datagrid name="roleList" title="角色列表" actionUrl="${basePath }/roleController.do?roleGrid" idField="id">
   ...
   <t:dgToolBar title="角色录入" icon="icon-add" url="${basePath }/roleController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="角色编辑" icon="icon-edit" url="${basePath }/roleController.do?addorupdate" funname="update"></t:dgToolBar>
  </t:datagrid>
 </div>
...
function delRole(id){
	...
	var url= '${basePath }/roleController.do?delRole&id='+id;
