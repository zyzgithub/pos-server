...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="${basePath }/userController.do?saveUser">
   ...
   <table style="width:600px;" cellpadding="0" cellspacing="1" class="formtable">
    <tr>
     ...
     ${user.userName }
      ...
      <c:if test="${user.id==null }">
       <input id="userName" class="inputxt" name="userName" ajaxurl="${basePath }/userController.do?checkUser&code=${user.userName }" value="${user.userName }" datatype="s2-10" >
    ...
    <tr>
     ...
     <td class="value">
      <select id=""  name="isLeader"  datatype="*">
        <option value="0" <c:if test="${isLeader==0}">selected="selected"</c:if>>否
        </option>
        <option value="1" <c:if test="${isLeader==1}">selected="selected"</c:if>>是
        </option>
      </select>
    ...
    <tr>
     ...
     <td class="value" nowrap>
      ...
      <t:choose hiddenName="roleid" hiddenid="id" url="${basePath }/userController.do?roles" name="roleList" icon="icon-choose" title="角色列表" textname="roleName" isclear="true"></t:choose>
    ...
    <tr>
     ...
     <td class="value">
      ...
      <input class="inputxt" name="mobilePhone" value="${user.mobilePhone}" datatype="m" errormsg="手机号码不正确!" ignore="ignore" ajaxurl="userController.do?checkUserMobilePhone&code=${user.mobilePhone }">
