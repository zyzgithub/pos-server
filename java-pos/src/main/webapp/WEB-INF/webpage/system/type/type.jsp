...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" layout="div" dialog="true" action="${basePath }/systemController.do?saveType">
   ...
   <fieldset class="step">
    ...
    <div class="form">
     ...
     <input name="typecode" class="inputxt" ajaxurl="${basePath }/systemController.do?checkType&code=${type.typecode }&typeGroupCode=${type.TSTypegroup.typegroupcode}"  value="${type.typecode }"  datatype="s1-10">
