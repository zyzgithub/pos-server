...
public class UpmpService{
	private static final Logger logger = Logger.getLogger(UpmpService.class);
	/**
	 * 交易接口处理
	 * @param req 请求要素
	 * @param resp 应答要素
	...
	public static boolean trade(Map<String, String> req, Map<String, String> resp) {
		...
		logger.info("银联trade nvp:" + nvp);
		logger.info("银联trade respString:" +respString);
	...
	public static boolean query(Map<String, String> req, Map<String, String> resp){
		...
		System.out.println("nvp:" + nvp);
		logger.info("query nvp:" + nvp);
		logger.info("query respString:" +respString);
		return verifyResponse(respString, resp);
	}
