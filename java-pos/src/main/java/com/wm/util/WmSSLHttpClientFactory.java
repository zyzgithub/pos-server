...
public class WmSSLHttpClientFactory {
	
	private final static Logger logger = LoggerFactory.getLogger(WmSSLHttpClientFactory.class);
	...
	private void init() 
		...
		certLocalPath = certLocalPath.substring(0, certLocalPath.indexOf("classes/")) + EnvConfig.base.APICLIENT_CERT_FILE;
	...
	private WmSSLHttpClientFactory()throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException{
		init();
	}
