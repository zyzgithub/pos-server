...
public class ClientConfig extends HashMap<String, Object> {
	...
	private static final long serialVersionUID = -1815712788637312436L;
    ...
    public static void setDeviceHostName(Map<String, Object> conf, String hostName) {
    ...
    public static void setPushHostName(Map<String, Object> conf, String hostName) {
    ...
    public static void setReportHostName(Map<String, Object> conf, String hostName) {
    ...
    public static void setScheduleHostName(Map<String, Object> conf, String hostName) {
