...
//	private static final ResourceBundle bundle = java.util.ResourceBundle.getBundle("sysConfig");
	...
	/*public static final String getJdbcUrl() {
		return bundle.getString("databaseType").toLowerCase();
	}*/
	
	//获取interval
	/*public static final String getInterval() {
		return bundle.getString("interval").toLowerCase();
	}*/
	
	//获取sessionTimeout
	/*public static final String getSessionTimeout() {
		return bundle.getString("sessionTimeout").toLowerCase();
	}*/
