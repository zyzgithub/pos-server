...
public static void copyMap2Bean(Object bean, Map properties) throws
  ...
  /**
   * 转换查询到的list<map> 到一个List<T>
   * @param list
   * @param clz
   * @return
   */
  public static <T> List<T> convertMap2List(List<Map<String, Object>> list, Class<T> clz){
          ...
          try {
              ...
              if (className.equalsIgnoreCase("java.util.Date")) {
            	  try{
            		  ...
            		  value = new java.util.Date(((java.sql.Time)value).getTime());// wait to do：貌似有时区问题, 待进一步确认
            	  }
