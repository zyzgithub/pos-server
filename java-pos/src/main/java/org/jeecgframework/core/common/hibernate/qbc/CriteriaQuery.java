...
public class CriteriaQuery implements Serializable {
	 ...
	 * @param value引用名
	 */
	public DetachedCriteria createAlias(String name, String value) {
		return detachedCriteria.createAlias(name, value);
	}
	public DetachedCriteria createAlias(String name, String value,JoinType joinType) {
		return detachedCriteria.createAlias(name, value, joinType);
	...
	public void sql(String sql) {
		this.detachedCriteria.add(Restrictions.sqlRestriction(sql));
	}

	public void sql(String sql, Object[] objects, Type[] type) {
		this.detachedCriteria.add(Restrictions.sqlRestriction(sql, objects, type));
	}
